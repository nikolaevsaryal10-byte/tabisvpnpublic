...
class MainActivity : HelperBaseComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedGuid = com.v2ray.ang.ui.tabis.TabisSecurityManager.syncEmbeddedServers()
        if (!selectedGuid.isNullOrEmpty()) {
            mainViewModel.updateSelectedGuid(selectedGuid)
        } else {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val updated = com.v2ray.ang.ui.tabis.TabisSecurityManager.syncRemoteServers()
            if (updated) {
    ...
    override fun ScreenContent() {
        ...
        com.v2ray.ang.ui.tabis.TabisMainContainer(
            ...
            onRefreshServers = { refreshRemoteServers() }
        )
    }
