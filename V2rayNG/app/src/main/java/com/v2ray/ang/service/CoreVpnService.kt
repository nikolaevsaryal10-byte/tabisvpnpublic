...
//    }
    ...
    private fun configureNetworkSettings(builder: Builder) {
        ...
        // Configure IPv6 if enabled or inject blackhole to prevent route leaks
    ...
    private fun runTun2socks() {
        if (SettingsManager.isUsingHevTun()) {
            try {
                ...
                LogUtil.e(AppConfig.TAG, "StartCore-VPN: Failed to load TProxyService, falling back to native TUN", e)
